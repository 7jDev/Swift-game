...
let sol = SKSpriteNode(imageNamed: "war1")
    ...
    let classic = SKLabelNode(text: "punch :damage 20 ,60% chance")
    ...
    let monstertext = SKLabelNode(text: " \(monHEATH2)/400")
    ...
    var rocketAnimArray = [SKTexture(imageNamed: "0_Golem_Slashing_000"),SKTexture(imageNamed: "0_Golem_Slashing_001"),SKTexture(imageNamed: "0_Golem_Slashing_002"),SKTexture(imageNamed: "0_Golem_Slashing_003"),SKTexture(imageNamed: "0_Golem_Slashing_004"),SKTexture(imageNamed: "0_Golem_Slashing_005"),SKTexture(imageNamed: "0_Golem_Slashing_006"),SKTexture(imageNamed: "0_Golem_Slashing_007"),SKTexture(imageNamed: "0_Golem_Slashing_008"),SKTexture(imageNamed: "0_Golem_Slashing_009"),SKTexture(imageNamed: "0_Golem_Slashing_010"),SKTexture(imageNamed: "0_Golem_Slashing_011")]
 ...
 var player: AVAudioPlayer?
    ...
    override func didMove(to view: SKView) {
        ...
        back()
        label()
        UserDefaults.standard.set(monHEATH2, forKey: "mon")
    ...
    func updatescore(){
        monstertext.text = "\(monHEATH2 )/400"
    ...
    func MONROUNDONE() {
        ...
        monster.size = CGSize(width: frame.size.width/5, height: frame.size.height/5)
        addChild(monster)
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        monHEATH2 = 200
              ...
              if monHEATH2 <= 0{
                  ...
                  personHEATH3 = 400
                  let deed = round3(size: view!.bounds.size)
                  view?.presentScene(deed)
                ...
                UserDefaults.standard.set(exp + 1500, forKey: "RANK")
                viewexp += 1500
                    monHEATH2 = 400
                }
              }
